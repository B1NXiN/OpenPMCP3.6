         ...
         profileCache.getAsync(pProfile.getName(), (p_182470_) -> {
            Util.backgroundExecutor().execute(() -> {
               ...
               Util.ifElse(p_182470_, (p_276255_) -> {
                  if (p_276255_ == null) {
                     System.out.println("无法从缓存中获取玩家资料：" + pProfile.getName());
                     return;
                  }
                  ...
                  if (property == null) {
                     ...
                     if (ClientSetting.Instance.heypixelGameprofileValue.getValue()) {
                     ...
                     if (p_276255_ == null) {
                        System.out.println("填充玩家资料失败：" + pProfile.getName());
                        return;
                     }
                  }
