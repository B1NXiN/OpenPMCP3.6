...
public class ChunkStatus {
   ...
   ChunkStatus(@Nullable ChunkStatus pParent, int pRange, boolean pHasLoadDependencies, EnumSet<Heightmap.Types> pHeightmapsAfter, ChunkStatus.ChunkType pChunkType, ChunkStatus.GenerationTask pGenerationTask, ChunkStatus.LoadingTask pLoadingTask) {
