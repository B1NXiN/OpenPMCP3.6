...
public class LootDataType<T> {
   ...
   private LootDataType(Gson pParser, BiFunction<Gson, String, BiFunction<ResourceLocation, JsonElement, Optional<T>>> pTopDeserializerGetter, String pDirectory, LootDataType.Validator<T> pValidator) {
      this.parser = pParser;
   ...
   public Optional<T> deserialize(ResourceLocation pLocation, JsonElement pJson) {
      return this.topDeserializer.apply(pLocation, pJson);
   }
   ...
   private static <T> BiFunction<Gson, String, BiFunction<ResourceLocation, JsonElement, Optional<T>>> createSingleDeserialiser(Class<T> pValueType) {
   ...
   private static <T> BiFunction<Gson, String, BiFunction<ResourceLocation, JsonElement, Optional<T>>> createSingleOrMultipleDeserialiser(Class<T> pValueType, Function<T[], T> pCombiner) {
