...
public class CreativeModeTabs {
   ...
   public static CreativeModeTab bootstrap(Registry<CreativeModeTab> pRegistry) {
      Registry.register(pRegistry, BUILDING_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 0).title(Component.translatable("itemGroup.buildingBlocks")).icon(() -> {
      ...
      Registry.register(pRegistry, COLORED_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 1).title(Component.translatable("itemGroup.coloredBlocks")).icon(() -> {
      ...
      Registry.register(pRegistry, NATURAL_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 2).title(Component.translatable("itemGroup.natural")).icon(() -> {
      ...
      Registry.register(pRegistry, FUNCTIONAL_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 3).title(Component.translatable("itemGroup.functional")).icon(() -> {
      ...
      Registry.register(pRegistry, REDSTONE_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 4).title(Component.translatable("itemGroup.redstone")).icon(() -> {
      ...
      Registry.register(pRegistry, HOTBAR, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 5).title(Component.translatable("itemGroup.hotbar")).icon(() -> {
         return new ItemStack(Blocks.BOOKSHELF);
      }).alignedRight().type(CreativeModeTab.Type.HOTBAR).build());
      Registry.register(pRegistry, SEARCH, CreativeModeTab.builder(CreativeModeTab.Row.TOP, 6).title(Component.translatable("itemGroup.search")).icon(() -> {
      ...
      Registry.register(pRegistry, TOOLS_AND_UTILITIES, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 0).title(Component.translatable("itemGroup.tools")).icon(() -> {
      ...
      Registry.register(pRegistry, COMBAT, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 1).title(Component.translatable("itemGroup.combat")).icon(() -> {
      ...
      Registry.register(pRegistry, FOOD_AND_DRINKS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 2).title(Component.translatable("itemGroup.foodAndDrink")).icon(() -> {
      ...
      Registry.register(pRegistry, INGREDIENTS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 3).title(Component.translatable("itemGroup.ingredients")).icon(() -> {
      ...
      Registry.register(pRegistry, SPAWN_EGGS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 4).title(Component.translatable("itemGroup.spawnEggs")).icon(() -> {
      ...
      Registry.register(pRegistry, OP_BLOCKS, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 5).title(Component.translatable("itemGroup.op")).icon(() -> {
      ...
      return Registry.register(pRegistry, INVENTORY, CreativeModeTab.builder(CreativeModeTab.Row.BOTTOM, 6).title(Component.translatable("itemGroup.inventory")).icon(() -> {
   ...
   private static void generatePotionEffectTypes(CreativeModeTab.Output pOutput, HolderLookup<Potion> pPotions, Item pPotionItem, CreativeModeTab.TabVisibility pTabVisibility) {
      pPotions.listElements().filter((p_270012_) -> {
         return !p_270012_.is(Potions.EMPTY_ID);
      }).map((p_269986_) -> {
         return PotionUtils.setPotion(new ItemStack(pPotionItem), p_269986_.value());
      }).forEach((p_270000_) -> {
         pOutput.accept(p_270000_, pTabVisibility);
      });
   }
   ...
   private static void generateEnchantmentBookTypesOnlyMaxLevel(CreativeModeTab.Output pOutput, HolderLookup<Enchantment> pEnchantments, Set<EnchantmentCategory> pCategories, CreativeModeTab.TabVisibility pTabVisibility) {
      pEnchantments.listElements().map(Holder::value).filter((p_270008_) -> {
         return pCategories.contains(p_270008_.category);
      }).map((p_270038_) -> {
         return EnchantedBookItem.createForEnchantment(new EnchantmentInstance(p_270038_, p_270038_.getMaxLevel()));
      }).forEach((p_269989_) -> {
         pOutput.accept(p_269989_, pTabVisibility);
      });
   }
   ...
   private static void generateEnchantmentBookTypesAllLevels(CreativeModeTab.Output pOutput, HolderLookup<Enchantment> pEnchantments, Set<EnchantmentCategory> pCategories, CreativeModeTab.TabVisibility pTabVisibility) {
      pEnchantments.listElements().map(Holder::value).filter((p_269991_) -> {
         return pCategories.contains(p_269991_.category);
      }).flatMap((p_270024_) -> {
         ...
         pOutput.accept(p_270017_, pTabVisibility);
      });
   }
   ...
   private static void generateInstrumentTypes(CreativeModeTab.Output pOutput, HolderLookup<Instrument> pInstruments, Item pItem, TagKey<Instrument> pInstrument, CreativeModeTab.TabVisibility pTabVisibility) {
      pInstruments.get(pInstrument).ifPresent((p_270021_) -> {
         p_270021_.stream().map((p_269995_) -> {
            return InstrumentItem.create(pItem, p_269995_);
         }).forEach((p_270011_) -> {
