...
public class MobEffectInstance implements Comparable<MobEffectInstance> {
   ...
   public int compareTo(MobEffectInstance pOther) {
      int i = 32147;
      return (this.getDuration() <= 32147 || pOther.getDuration() <= 32147) && (!this.isAmbient() || !pOther.isAmbient()) ? ComparisonChain.start().compareFalseFirst(this.isAmbient(), pOther.isAmbient()).compareFalseFirst(this.isInfiniteDuration(), pOther.isInfiniteDuration()).compare(this.getDuration(), pOther.getDuration()).compare(this.getEffect().getColor(), pOther.getEffect().getColor()).result() : ComparisonChain.start().compare(this.isAmbient(), pOther.isAmbient()).compare(this.getEffect().getColor(), pOther.getEffect().getColor()).result();
   }
