...
public class MemoryModuleType<U> {
   ...
   private static <U> MemoryModuleType<U> register(String pIdentifier, Codec<U> pCodec) {
      return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, new ResourceLocation(pIdentifier), new MemoryModuleType<>(Optional.of(pCodec)));
   }

   private static <U> MemoryModuleType<U> register(String pIdentifier) {
      return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, new ResourceLocation(pIdentifier), new MemoryModuleType<>(Optional.empty()));
   }
}