...
public class Allay extends PathfinderMob implements InventoryCarrier, VibrationSystem {
   ...
   public boolean wantsToPickUp(ItemStack pStack) {
      ...
      return !itemstack.isEmpty() && this.level().getGameRules().getBoolean(GameRules.RULE_MOBGRIEFING) && this.inventory.canAddItem(pStack) && this.allayConsidersItemEqual(itemstack, pStack);
   }
