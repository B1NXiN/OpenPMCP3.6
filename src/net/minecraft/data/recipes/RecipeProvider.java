...
public abstract class RecipeProvider implements DataProvider {
   ...
   public CompletableFuture<?> run(CachedOutput pOutput) {
      ...
      this.buildRecipes((p_253413_) -> {
         if (!set.add(p_253413_.getId())) {
            ...
            if (jsonobject != null) {
               list.add(DataProvider.saveStable(pOutput, jsonobject, this.advancementPathProvider.json(p_253413_.getAdvancementId())));
            }
   ...
   protected static void generateForEnabledBlockFamilies(Consumer<FinishedRecipe> pFinishedRecipeConsumer, FeatureFlagSet pEnabledFeatures) {
   ...
   private static void oreCooking(Consumer<FinishedRecipe> pFinishedRecipeConsumer, RecipeSerializer<? extends AbstractCookingRecipe> pCookingSerializer, List<ItemLike> pIngredients, RecipeCategory pCategory, ItemLike pResult, float pExperience, int pCookingTime, String pGroup, String pRecipeName) {
   ...
   private static RecipeBuilder pressurePlateBuilder(RecipeCategory pCategory, ItemLike pPressurePlate, Ingredient pMaterial) {
   ...
   private static RecipeBuilder wallBuilder(RecipeCategory pCategory, ItemLike pWall, Ingredient pMaterial) {
   ...
   private static RecipeBuilder polishedBuilder(RecipeCategory pCategory, ItemLike pResult, Ingredient pMaterial) {
   ...
   private static ShapedRecipeBuilder cutBuilder(RecipeCategory pCategory, ItemLike pCutResult, Ingredient pMaterial) {
   ...
   private static void nineBlockStorageRecipes(Consumer<FinishedRecipe> pFinishedRecipeConsumer, RecipeCategory pUnpackedCategory, ItemLike pUnpacked, RecipeCategory pPackedCategory, ItemLike pPacked, String pPackedName, @Nullable String pPackedGroup, String pUnpackedName, @Nullable String pUnpackedGroup) {
   ...
   private static void simpleCookingRecipe(Consumer<FinishedRecipe> pFinishedRecipeConsumer, String pCookingMethod, RecipeSerializer<? extends AbstractCookingRecipe> pCookingSerializer, int pCookingTime, ItemLike pIngredient, ItemLike pResult, float pExperience) {
