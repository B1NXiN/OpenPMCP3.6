...
public class EntityRenderDispatcher implements ResourceManagerReloadListener {
   ...
   public <E extends Entity> void renderInvEntity(E pEntity, double pX, double pY, double pZ, float pRotationYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
      if (this.camera != null) {
         EntityRenderer<? super E> entityrenderer = this.getRenderer(pEntity);
   ...
   public <E extends Entity> void render(E pEntity, double pX, double pY, double pZ, float pRotationYaw, float pPartialTicks, PoseStack pPoseStack, MultiBufferSource pBuffer, int pPackedLight) {
      if (AntiBot.Instance != null && AntiBot.Instance.isEnable()) {
         if (AntiBot.Instance.entityList.contains(pEntity)) {
