...
import pmcp.mode.hud.DynamicIsLand;
...
public class PlayerTabOverlay {
   ...
   public Component getNameForDisplay(PlayerInfo p_94550_) {
      if (p_94550_.ircUser != null) {
         return Component.literal(" [" + ChatFormatting.RED + "IRC" + ChatFormatting.WHITE + "] " + ChatFormatting.AQUA + p_94550_.ircUser.getUsername() + ChatFormatting.WHITE + "(" + p_94550_.ircUser.getRank() + ChatFormatting.WHITE + ")");
      }
   ...
   public void render(GuiGraphics pGuiGraphics, int pWidth, Scoreboard pScoreboard, @Nullable Objective pObjective) {
      if (DynamicIsLand.Instance.isEnable()) return;
   ...
   public void setFooter(@Nullable Component pFooter) {
      ...
      DynamicIsLand.Instance.footer = pFooter;
   }

   public void setHeader(@Nullable Component pHeader) {
      this.header = pHeader;

      DynamicIsLand.Instance.header = pHeader;
   }

   public void reset() {
      this.header = null;
      this.footer = null;
      DynamicIsLand.Instance.header = null;
      DynamicIsLand.Instance.footer = null;
   }
