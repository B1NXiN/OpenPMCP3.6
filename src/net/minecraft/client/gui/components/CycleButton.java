...
public class CycleButton<T> extends AbstractButton implements IOptionControl {
   ...
   private void cycleValue(int pDelta) {
      if (this.option instanceof IteratableOptionOF) {
         IteratableOptionOF iteratableoptionof = (IteratableOptionOF)this.option;
   ...
   public void updateWidgetNarration(NarrationElementOutput pNarrationElementOutput) {
      ...
      if (this.active) {
         ...
         if (this.isFocused()) {
            pNarrationElementOutput.add(NarratedElementType.USAGE, Component.translatable("narration.cycle_button.usage.focused", component));
         } else {
            pNarrationElementOutput.add(NarratedElementType.USAGE, Component.translatable("narration.cycle_button.usage.hovered", component));
         }
      }
   ...
   public static class Builder<T> {
      ...
      private final Function<T, Component> valueStringifier;
      private OptionInstance.TooltipSupplier<T> tooltipSupplier = (p_257070_0_) -> {
         return null;
      };
