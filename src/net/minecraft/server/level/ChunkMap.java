...
public class ChunkMap extends ChunkStorage implements ChunkHolder.PlayerProvider {
   ...
   public CompletableFuture<Either<LevelChunk, ChunkHolder.ChunkLoadingFailure>> prepareEntityTickingChunk(ChunkHolder pChunk) {
      return this.getChunkRangeFuture(pChunk, 2, (p_203077_0_) -> {
         ...
         return p_212877_0_.mapLeft((p_203091_0_) -> {
         ...
         return !chunkstatus.isOrAfter(ChunkStatus.FULL) ? ChunkHolder.UNLOADED_CHUNK : p_287044_2_.mapLeft((p_214854_2_) -> {
            ...
            if (this.entitiesInLevel.add(chunkpos.toLong())) {
               ...
               try {
                  ...
                  Reflector.postForgeBusEvent(Reflector.ChunkEvent_Load_Constructor, levelchunk, !(protochunk instanceof ImposterProtoChunk));
               } finally {
   ...
   public CompletableFuture<Either<LevelChunk, ChunkHolder.ChunkLoadingFailure>> prepareTickingChunk(ChunkHolder pHolder) {
      ...
      CompletableFuture<Either<LevelChunk, ChunkHolder.ChunkLoadingFailure>> completablefuture1 = completablefuture.thenApplyAsync((p_279889_0_) -> {
         return p_279889_0_.mapLeft((p_214938_0_) -> {
      ...
      }).thenApplyAsync((p_214929_1_) -> {
         return p_214929_1_.ifLeft((p_214959_1_) -> {
            p_214959_1_.postProcessGeneration();
            this.level.startTickingChunk(p_214959_1_);
         });
      }, this.mainThreadExecutor);
      ...
      completablefuture1.thenAcceptAsync((p_214880_2_) -> {
         p_214880_2_.ifLeft((p_287047_2_) -> {
            MutableObject<ClientboundLevelChunkWithLightPacket> mutableobject = new MutableObject<>();
            this.getPlayers(pHolder.getPos(), false).forEach((p_214908_3_) -> {
               this.playerLoadedChunk(p_214908_3_, mutableobject, p_287047_2_);
            });
         });
      }, (p_214920_2_) -> {
         this.mainThreadMailbox.tell(ChunkTaskPriorityQueueSorter.message(pHolder, p_214920_2_));
      });
      return completablefuture1;
   }
   ...
   public CompletableFuture<Either<LevelChunk, ChunkHolder.ChunkLoadingFailure>> prepareAccessibleChunk(ChunkHolder pHolder) {
      return this.getChunkRangeFuture(pHolder, 1, ChunkStatus::getStatusAroundFullChunk).thenApplyAsync((p_203085_0_) -> {
         return p_203085_0_.mapLeft((p_214904_0_) -> {
            return (LevelChunk)p_214904_0_.get(p_214904_0_.size() / 2);
         });
      }, (p_214857_2_) -> {
   ...
   protected void setViewDistance(int pViewDistance) {
      ...
      if (i != this.viewDistance) {
         ...
         for(ChunkHolder chunkholder : this.updatingChunkMap.values()) {
            ...
            MutableObject<ClientboundLevelChunkWithLightPacket> mutableobject = new MutableObject<>();
            this.getPlayers(chunkpos, false).forEach((p_214860_4_) -> {
               SectionPos sectionpos = p_214860_4_.getLastSectionPos();
               ...
               this.updateChunkTracking(p_214860_4_, chunkpos, mutableobject, flag, flag1);
            });
         }
      }
   ...
   protected void updateChunkTracking(ServerPlayer pPlayer, ChunkPos pChunkPos, MutableObject<ClientboundLevelChunkWithLightPacket> pPacketCache, boolean pWasLoaded, boolean pLoad) {
      if (pPlayer.level() == this.level) {
         ...
         if (!pLoad && pWasLoaded) {
            ...
            if (Reflector.ForgeEventFactory_fireChunkUnWatch.exists()) {
               Reflector.ForgeEventFactory_fireChunkUnWatch.call(pPlayer, pChunkPos, this.level);
            }
         }
      }
   ...
   public void resendBiomesForChunks(List<ChunkAccess> pChunks) {
      ...
      map.forEach((p_274109_0_, p_274109_1_) -> {
         p_274109_0_.connection.send(ClientboundChunksBiomesPacket.forChunks(p_274109_1_));
      });
   }
   ...
   private void playerLoadedChunk(ServerPlayer pPlayer, MutableObject<ClientboundLevelChunkWithLightPacket> pPacketCache, LevelChunk pChunk) {
      ...
      if (Reflector.ForgeEventFactory_fireChunkWatch.exists()) {
         Reflector.ForgeEventFactory_fireChunkWatch.call(pPlayer, pChunk, this.level);
      }
