...
public class Mth {
   ...
   public static float sin(float pValue) {
      return fastMath ? SIN_TABLE_FAST[(int)(pValue * radToIndex) & 4095] : SIN[(int)(pValue * 10430.378F) & '\uffff'];
   }

   public static float cos(float pValue) {
      return fastMath ? SIN_TABLE_FAST[(int)(pValue * radToIndex + 1024.0F) & 4095] : SIN[(int)(pValue * 10430.378F + 16384.0F) & '\uffff'];
   }
