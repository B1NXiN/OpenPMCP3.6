...
public class VersionCheckThread extends Thread {
   ...
   public void run() {
      ...
      try {
         ...
         URL url = new URL("http://optifine.net/version/1.20.1/HD_U.txt");
         httpurlconnection = (HttpURLConnection)url.openConnection();
         boolean flag = true;
         if (flag) {
            httpurlconnection.setRequestProperty("OF-MC-Version", "1.20.1");
            ...
            httpurlconnection.setRequestProperty("OF-Release", "I6");
         ...
         try {
            ...
            if (astring.length >= 1) {
               ...
               if (Config.compareRelease(s1, "I6") <= 0) {
                  return;
               }
