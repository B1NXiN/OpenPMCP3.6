...
public class RealmsNotificationsScreen extends RealmsScreen {
   ...
   private final RealmsNotificationsScreen.DataFetcherConfiguration onlyNotifications = new RealmsNotificationsScreen.DataFetcherConfiguration() {
      public DataFetcher.Subscription initDataFetcher(RealmsDataFetcher p_275731_) {
         DataFetcher.Subscription datafetcher$subscription = p_275731_.dataFetcher.createSubscription();
         RealmsNotificationsScreen.this.addNotificationsSubscriptions(p_275731_, datafetcher$subscription);
         return datafetcher$subscription;
      }
